...
SKILL_CATALOG: list[dict] = [
    ...
    # 以下能力主要作為既有案子「已掛能力」的目錄項(demo 資料會掛上)。
    {
        "name": "行動端版面",
        "role_key": "design",
        "applies_tags": ["mobile"],
        "trigger_expr": None,
        "content": "單手可及的行動端版面與元件規格。",
        "affects_score": "design",
        "risk_level": "low",
        "conflict_group": None,
        "reason_template": "手機上要好按、好讀,版面先照行動端排。",
        "predicted_effect": "設計層更貼近實際使用情境。",
    },
    {
        "name": "表單版面",
        "role_key": "design",
        "applies_tags": ["internal"],
        "trigger_expr": None,
        "content": "以資料輸入為主的表單版面。",
        "affects_score": "design",
        "risk_level": "low",
        "conflict_group": None,
        "reason_template": "內部工具重在快速輸入,版面以表單為核心。",
        "predicted_effect": "設計層更符合輸入密集的情境。",
    },
    {
        "name": "排程引擎",
        "role_key": "code",
        ...
        "risk_level": "low",
        "conflict_group": None,
        "reason_template": "出貨要按時間自動跑,需要一顆穩定的排程引擎。",
        "predicted_effect": "程式層具備自動排程能力。",
    },
    {
        "name": "快取層",
        "role_key": "code",
        "applies_tags": ["data"],
        "trigger_expr": None,
        "content": "常用查詢加上快取,降低延遲。",
        "affects_score": "code",
        "risk_level": "low",
        "conflict_group": None,
        "reason_template": "報表查詢量大,加一層快取讓開啟更快。",
        "predicted_effect": "程式層回應更快。",
    },
]
